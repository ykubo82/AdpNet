...
parser.add_argument(
    ...
    nargs = '+',
    type=float,
    default=[0.021, 0.021, 0.21], # for the best
    metavar='LR',
...
parser.add_argument(
    ...
    type=int,
    default=5,
    metavar='adj_acom_step',
    help='adjusted accommodation step (default: 5)')  
parser.add_argument(
    '--coe',
    type=int,
    default=0.1,
    metavar='coe',
    help='coefficient for free phase at adjusted accommodation step (default: 5)')  
parser.add_argument(
    '--beta',
    type=float,
    default=0.18,
...
parser.add_argument(
    '--pred_inps_with_delay',
    nargs = '+',
    type=int,
    default=[4, 6, 8, 20, 80, 110],
    metavar='Pred_inputs with delay',
    help='prediction inputs and delay (delay will be the last) (default: [])') 
parser.add_argument(
    '--training-method',
    type=str,
    default='eqprop',
...
pred_inps_with_delay = args.pred_inps_with_delay
